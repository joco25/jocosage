        ...
        <div className='w-full px-[12%] py-10 scroll-mt-20 min-h-screen' id='about'>
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                <div className="w-64 sm:w-80 rounded-3xl max:w-none">
                    <Image src={assets.user_image} alt='profile imgage' className='w-full rounded-3xl'></Image>
                </div>

                <div className="flex-1">
                    <p className='mb-10 max-w-2xl font-Ovo'>I am a Staff-level Software Engineer with over 13 years of experience architecting and delivering highly scalable, data-intensive applications. I am passionate about solving technical problems and user-centric design. Over the years, I have used my expertise in the frontend, backend and distributed systems to build products that are technically sound, intuitive and impactful. I am an advocate for continuous learning. I love crafting and evolving design systems, and most recently, I have been experimenting with AI engineering, workflows and techniques. With an M.Sc. in Data Science, I have also been working on transforming complex data into meaningful user experiences and driving innovation through custom LLMs, AI and machine learning models.</p>
