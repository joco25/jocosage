            ...
            ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50 dark:border dark:border-white/50 dark:bg-transparent"} `}>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <button onClick={() => setIsDarkMode(prev => !prev)}>
                        <Image src={isDarkMode ? assets.sun_icon : assets.moon_icon} className='w-6 cursor-pointer ' alt='moon icon'></Image>
                    </button>
                ...
                top-0 bottom-0 w-64 z-50 h-screen bg-blue-500 transition duration-500 dark:bg-indigo-600 dark:text-white' ref={sideMenuRef}>
                    ...
                    <div className='absolute top-5 right-5' onClick={closeMenu}>
                        <Image src={isDarkMode ? assets.close_white : assets.close_black} alt='close' className='w-5 cursor-pointer'></Image>
                    </div>
